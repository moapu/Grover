...
public class Climate {
    ...
    public String get_climateId() {
        return _climateId;
    }

    public void set_climateId(String _climateId) {
        this._climateId = _climateId;
    }

    private String _climateId;
     ...
     */
    public void set_tempMax(float tempMax) {
     ...
     */
    public void set_tempMin(float tempMin) {
     ...
     */
    public void set_humidMin(float humidMin) {
        this._humidMin = humidMin;
    }
     ...
     */
    public void set_humidMax(float humidMax) {
        this._humidMax = humidMax;
    }
     ...
     */
    public void set_baroMin(float baroMin) {
        this._baroMin = baroMin;
    }
     ...
     */
    public void set_baroMax(float baroMax) {
        this._baroMax = baroMax;
    }

    /**
     * Calls the MissionTemplateWebService based on the climate type specified by the user. The web
     * service will contact ServiceNow and retrieve the mission parameters for that climate. If
     * successful, onPostExecute will set the temperature, humidity and barometric pressure.
     *
    ...
    public void getMissionTemplate(String climateType, Activity activity) {
        try {
            if (!climateType.isEmpty()) {
                ...
                climateType = this.get_climateType().replaceAll("\\s", "");
